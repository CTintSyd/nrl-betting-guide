...
const NRL_TEAM_DATA = {
  ...
  'Canberra Raiders': {
    ...
    players: [
      ...
      { name: "Kaeo Weekes",                       pos: "fullback",       tryRate: 0.55 },
      { name: "Ethan Strange",                     pos: "five-eighth",    tryRate: 0.3529 },
      { name: "Matthew Timoko",                    pos: "centre",         tryRate: 0.375 },
  ...
  'Cronulla Sutherland Sharks': {
    ...
    players: [
      { name: "Sione Katoa",                       pos: "wing",           tryRate: 0.7692 },
      { name: "William Kennedy",                   pos: "fullback",       tryRate: 0.4737 },
      { name: "Braydon Trindall",                  pos: "five-eighth",    tryRate: 0.4211 },
      { name: "KL Iro",                            pos: "centre",         tryRate: 0.6667 },
      { name: "Ronaldo Mulitalo",                  pos: "wing",           tryRate: 1.0 },
      { name: "Teig Wilton",                       pos: "lock",           tryRate: 0.4118 },
    ],
  },
  ...
  'Gold Coast Titans': {
    ...
    players: [
      { name: "Phillip Sami",                      pos: "wing",           tryRate: 0.6316 },
      { name: "Keano Kini",                        pos: "fullback",       tryRate: 0.1579 },
      { name: "Jayden Campbell",                   pos: "five-eighth",    tryRate: 0.5294 },
      { name: "Arama Hau",                         pos: "lock",           tryRate: 0.3684 },
      { name: "Jojo Fifita",                       pos: "centre",         tryRate: 0.4118 },
      { name: "Oliver Pascoe",                     pos: "hooker",         tryRate: 0.25 },
    ],
  },
  ...
  'New Zealand Warriors': {
    ...
    players: [
      ...
      { name: "Charnze Nicoll-Klokstad",           pos: "fullback",       tryRate: 0.6667 },
      { name: "Te Maire Martin",                   pos: "halfback",       tryRate: 0.6 },
      { name: "Alofiana Khan-Pereira",             pos: "wing",           tryRate: 1.0 },
      { name: "Leka Halasima",                     pos: "centre",         tryRate: 0.375 },
      { name: "Chanel Harris-Tavita",              pos: "five-eighth",    tryRate: 0.2778 },
    ],
  },
  ...
  'North Queensland Cowboys': {
    ...
    players: [
      { name: "Braidon Burns",                     pos: "wing",           tryRate: 0.8125 },
      { name: "Scott Drinkwater",                  pos: "fullback",       tryRate: 0.45 },
      { name: "Jake Clifford",                     pos: "five-eighth",    tryRate: 0.35 },
      { name: "Murray Taulagi",                    pos: "wing",           tryRate: 0.7333 },
      { name: "Heilum Luki",                       pos: "lock",           tryRate: 0.4 },
      { name: "Tom Chester",                       pos: "centre",         tryRate: 0.4211 },
    ],
  },
  ...
  'Parramatta Eels': {
    ...
    players: [
      ...
      { name: "Isaiah Iongi",                      pos: "fullback",       tryRate: 0.4167 },
      { name: "Ronald Volkman",                    pos: "five-eighth",    tryRate: 0.2857 },
      { name: "Tallyn Da Silva",                   pos: "hooker",         tryRate: 0.3684 },
      { name: "Kelma Tuilagi",                     pos: "lock",           tryRate: 0.2222 },
      { name: "Brian Kelly",                       pos: "wing",           tryRate: 0.2353 },
    ],
  },
  ...
  'South Sydney Rabbitohs': {
    ...
    players: [
      { name: "Alex Johnston",                     pos: "wing",           tryRate: 1.375 },
      { name: "Matthew Dufty",                     pos: "fullback",       tryRate: 0.1667 },
      { name: "Cody Walker",                       pos: "five-eighth",    tryRate: 0.3889 },
      { name: "Latrell Mitchell",                  pos: "centre",         tryRate: 1.2222 },
      { name: "Campbell Graham",                   pos: "wing",           tryRate: 0.7143 },
  ...
  'Wests Tigers': {
    ...
    players: [
      { name: "Sunia Turuva",                      pos: "wing",           tryRate: 0.2 },
      { name: "Jahream Bula",                      pos: "fullback",       tryRate: 0.3529 },
      { name: "Adam Doueihi",                      pos: "halfback",       tryRate: 0.6154 },
      { name: "Taylan May",                        pos: "centre",         tryRate: 0.6667 },
      { name: "Jarome Luai",                       pos: "five-eighth",    tryRate: 0.25 },
